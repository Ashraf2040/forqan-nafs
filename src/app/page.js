...
import { initialState } from "./progress/page";
import Link from "next/link";

export default function Page() {
  const { numQuestions } = initialState;

  return (
    <section className="pt-20 md:pt-10 w-[75%]">
      <div className=" mx-auto px-4 lg:flex items-center">
        <div className="text-center lg:text-left lg:w-1/2">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-semibold leading-none">
            <span className="block mb-8 text-3xl">Welcome to</span>{" "}
